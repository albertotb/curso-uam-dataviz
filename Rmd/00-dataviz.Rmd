...
.center[
![:scale 80%](../img/visual_encoding.png)
]

.footnotesize[Fuente: Alberto Cairo. [Data Visualization for Storytelling and Discovery](https://journalismcourses.org/course/datavizforstorytelling/)]

---

## Jerarquia de codificaciones

.center[
![:scale 80%](../img/encoding_hierarchy.png)
]
...
## Visualizaciones multi-figura

Existen dos tipos principales:

 - facetas: cada figura muestra un sub-conjunto de los datos, generalmente en una rejilla regular
 
 - visualizaciones compuestas: distintas figuras que muestran distintos tipos de gráficos o incluso datos distintos

.center[
![:scale 60%](https://clauswilke.com/dataviz/multi-panel_figures_files/figure-html/titanic-passenger-breakdown-1.png)
]
...
.center[
![:scale 80%](https://clauswilke.com/dataviz/multi-panel_figures_files/figure-html/movie-rankings-1.png)
]
...
En general, los ejes tienen que tener las mismas escalas, para que se puedan comparar de forma visual:

.center[
![:scale 80%](https://clauswilke.com/dataviz/multi-panel_figures_files/figure-html/BA-degrees-variable-y-lims-1.png)
]

## Figuras compuestas

Importante usar un lenguaje visual consistente: fuentes, colores, símbolos, etc.

![](https://clauswilke.com/dataviz/multi-panel_figures_files/figure-html/athletes-composite-good-1.png)
...
.center[![:scale 80%](../img/elecciones_venezuela.png)]

Fuente: Alberto Cairo. [Graphics Lies, Misleading Visuals](https://journalismcourses.org/wp-content/uploads/2020/07/Misleading-Visuals.pdf)
...
.center[
![:scale 80%](../img/us_election_cloropleth.png)
]
---
...
.center[
![:scale 80%](../img/us_election_cartogram.png)
]
...
.center[
![:scale 70%](../img/us_election_density.jpg)
]
...
.center[
![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/mpg-cty-displ-solid-1.png)
]
...
.center[
![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/mpg-cty-displ-transp-1.png)
]
...
.center[![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/mpg-cty-displ-jitter-1.png)]

---

- Hay que tener cuidado con la cantidad de ruido, ya que estamos "falseando" los datos

.center[![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/mpg-cty-displ-jitter-extreme-1.png)]
...
.center[
![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/nycflights-points-1.png)
]
...
.center[
![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/nycflights-2d-bins-1.png)
]
...
.center[
 ![:scale 70%](https://clauswilke.com/dataviz/overlapping_points_files/figure-html/nycflights-hex-bins-1.png)
]
---
...
![:scale 60%](https://clauswilke.com/dataviz/telling_a_story_files/figure-html/arrival-delay-vs-distance-1.png)
...
.center[
![:scale 40%](https://clauswilke.com/dataviz/telling_a_story_files/figure-html/united-departures-weekdays-1.png)
]
